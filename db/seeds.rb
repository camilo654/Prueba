...
household_appliances = HouseholdAppliance.create([{ name: 'Tv', electricity_use: '5', user: users[0], outlet_id: outlets[0], category_id: categories[0], consumption: 57 },
                                                   { name: 'dvd', electricity_use: '3', user: users[0], outlet_id: outlets[0], category_id: categories[1], consumption: 23 },
                                                   { name: 'refrigerador', electricity_use: '2', user: users[0], outlet_id: outlets[0], category_id: categories[2], consumption: 32 },
                                                   { name: 'Tv', electricity_use: '3', user: users[1], outlet_id: outlets[12], category_id: categories[3], consumption: 44 },
                                                   { name: 'microondas', electricity_use: '2', user: users[1], outlet_id: outlets[14], category_id: categories[4], consumption: 28 },
                                                   { name: 'equipo de sonido', electricity_use: '3', user: users[1], outlet_id: outlets[13], category_id: categories[5], consumption: 41 },
                                                   { name: 'Tv2', electricity_use: '2', user: users[1], outlet_id: outlets[13], category_id: categories[3], consumption: 23 },
                                                   { name: 'xbox', electricity_use: '3', user: users[1], outlet_id: outlets[15], category_id: categories[3], consumption: 45 },
                                                   { name: 'Tv', electricity_use: '2', user: users[2], consumption: 13 },
                                                   { name: 'dvd', electricity_use: '3', user: users[2], consumption: 12 },
                                                   { name: 'licuadora', electricity_use: '2', user: users[2], consumption:34 },
                                                   { name: 'cafetera', electricity_use: '3', user: users[0], consumption: 23 },
                                                   { name: 'refrigerador', electricity_use: '2', user: users[2], consumption: 48 },
                                                   { name: 'pc', electricity_use: '5', user: users[1], consumption: 51 }])