...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { consumption: @register.consumption, date: @register.date } }, as: :json
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { consumption: @register.consumption, date: @register.date } }, as: :json
    assert_response 200
  end
